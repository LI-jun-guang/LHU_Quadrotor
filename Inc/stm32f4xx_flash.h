...
#define FLASH_Sector_0_EE     ((uint16_t)0) /*!< Sector Number 0 */
#define FLASH_Sector_1_EE     ((uint16_t)1) /*!< Sector Number 1 */
#define FLASH_Sector_2_EE     ((uint16_t)2) /*!< Sector Number 2 */
#define FLASH_Sector_3_EE     ((uint16_t)3) /*!< Sector Number 3 */
#define FLASH_Sector_4_EE     ((uint16_t)4) /*!< Sector Number 4 */
#define FLASH_Sector_5_EE     ((uint16_t)5) /*!< Sector Number 5 */
#define FLASH_Sector_6_EE     ((uint16_t)6) /*!< Sector Number 6 */
#define FLASH_Sector_7_EE     ((uint16_t)7) /*!< Sector Number 7 */
#define FLASH_Sector_8_EE     ((uint16_t)8) /*!< Sector Number 8 */
#define FLASH_Sector_9_EE     ((uint16_t)9) /*!< Sector Number 9 */
#define FLASH_Sector_10_EE    ((uint16_t)10) /*!< Sector Number 10 */
#define FLASH_Sector_11_EE    ((uint16_t)11) /*!< Sector Number 11 */
#define IS_FLASH_SECTOR_EE(SECTOR) (((SECTOR) == FLASH_Sector_0_EE) || ((SECTOR) == FLASH_Sector_1_EE) ||\
                                 ((SECTOR) == FLASH_Sector_2_EE) || ((SECTOR) == FLASH_Sector_3_EE) ||\
                                 ((SECTOR) == FLASH_Sector_4_EE) || ((SECTOR) == FLASH_Sector_5_EE) ||\
                                 ((SECTOR) == FLASH_Sector_6_EE) || ((SECTOR) == FLASH_Sector_7_EE) ||\
                                 ((SECTOR) == FLASH_Sector_8_EE) || ((SECTOR) == FLASH_Sector_9_EE) ||\
                                 ((SECTOR) == FLASH_Sector_10_EE) || ((SECTOR) == FLASH_Sector_11_EE))
#define IS_FLASH_ADDRESS_EE(ADDRESS) ((((ADDRESS) >= 0x08000000) && ((ADDRESS) < 0x080FFFFF)) ||\
